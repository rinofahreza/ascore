...
export default function Edit({ auth, mataPelajaran, cabangs }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('mata-pelajaran.update', mataPelajaran.id));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Mata Pelajaran</h2>}
        >
