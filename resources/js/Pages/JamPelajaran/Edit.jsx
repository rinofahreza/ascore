...
export default function Edit({ auth, jamPelajaran, cabangs, periodeAkademiks }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('jam-pelajaran.update', jamPelajaran.id));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Jam Pelajaran</h2>}
        >
