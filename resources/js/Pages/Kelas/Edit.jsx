...
export default function Edit({ auth, kelas, cabangs, levels }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Kelas</h2>}
        >
