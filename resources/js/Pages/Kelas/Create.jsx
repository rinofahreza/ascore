...
export default function Create({ auth, cabangs, levels }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Tambah Kelas</h2>}
        >
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        required
                                        placeholder="Contoh: Kelas 10A, Kelas 11 IPA 1"
                                    />
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        placeholder="Contoh: IPA, IPS, Teknik Informatika (Opsional)"
                                    />
