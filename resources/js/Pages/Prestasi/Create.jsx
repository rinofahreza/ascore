...
export default function Create({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Tambah Prestasi</h2>}
        >
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <TextInput
                                            ...
                                            placeholder="Contoh: Juara 1 Lomba Guru Berprestasi Tingkat Nasional"
                                            required
                                        />
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <div className="relative">
                                            <TextInput
                                                ...
                                                placeholder="Contoh: Medali Emas & Piagam Penghargaan"
                                                required
                                            />
                                ...
                                <div className="flex items-center justify-end mt-4 gap-3">
                                    ...
                                    <PrimaryButton disabled={processing || isCompressing}>
                                        {isCompressing ? 'Memproses Gambar...' : 'Simpan Prestasi'}
                                    </PrimaryButton>
                                </div>
                            </form>
                        </div>
