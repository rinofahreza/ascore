...
export default function Create({ auth, periodeAkademiks }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('semester-akademik.store'));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Tambah Semester Akademik</h2>}
        >
            <Head title="Tambah Semester Akademik" />
